...
struct ActivitiesShopComponents: View {
    var name: String
    var price: String
    var image: String
    var body: some View {
...
struct WallpaperShopComponents: View {
    var name: String
    var price: String
    var image: String
    var body: some View {
...
//IMAGE
            Image(image)
                .resizable()
                .frame(maxWidth: 74, maxHeight: 100)
                .border(.black, width: 3)
                .offset(x: -22, y: -20)
...
struct AvatarShopComponents: View {
    var name: String
    var price: String
    var image: String
    var body: some View {
...
//IMAGE
            Image(image)
                .resizable()
                .frame(maxWidth: 90, maxHeight: 95)
                .border(.black, width: 3)
                .offset(x: -22, y: -20)
...
struct ShopComponents_Previews: PreviewProvider {
    static var previews: some View {
        AvatarShopComponents(name: "Picasso", price: "4", image: "SelfPortraitPicasso")
    }
}
